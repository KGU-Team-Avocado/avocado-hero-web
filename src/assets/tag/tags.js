...
export const tags = {
    ...
    projects:[
        { type: "it", label: "웹(풀스택)", value: "web"},
        { type: "it", label: "웹(프론트엔드)", value: "web-frontend"},
        { type: "it", label: "웹(백엔드)", value: "web-backend"},
        { type: "it", label: "앱(Android)", value: "app-android"},
        { type: "it", label: "앱(iOS)", value: "app-ios"},
        { type: "it", label: "앱(하이브리드)", value: "app-hybrid"},
        { type: "it", label: "게임", value: "game"},
        { type: "it", label: "서버", value: "server"},
        { type: "it", label: "데이터베이스", value: "database"},
        { type: "it", label: "라즈베리파이", value: "raspberry-pi"},
        { type: "it", label: "인공지능", value: "ai"},
        { type: "it", label: "빅데이터", value: "bigdata"},
        { type: "it", label: "IoT", value: "iot"},
        { type: "it", label: "테스트", value: "test"},
    ]
}